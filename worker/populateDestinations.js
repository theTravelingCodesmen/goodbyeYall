...
let christTheRedeemer = {
  ...
  next_image_url: "/assets/images/Christ_the_redeemer2.png",
...
let machuPicchu = {
  ...
  next_image_url: "/assets/images/machu_picchu2.png",
...
let theGreatWall = {
    ...
    next_image_url:"/assets/images/wall_of_china2.png",
    country:"China",
...
let chichenItza = {
  ...
  next_image_url: "/assets/images/chichen_itza2.png",
...
let tajMahal = {
  ...
  next_image_url: "/assets/images/taj_mahal2.png",
...
let Colosseum = {
    ...
    next_image_url:"/assets/images/colusseum2.png",
    country:"Italy",
...
let Petra = {
    ...
    next_image_url:"/assets/images/petra2.png",
    country:"Jordan",
...
Promise.all(
destinationsArray.map(function (destination) {
